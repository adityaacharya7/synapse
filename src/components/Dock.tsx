    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={`${className} absolute -top-6 left-1/2 w-fit whitespace-pre rounded-md border border-border-subtle dark:border-neutral-700 bg-white dark:bg-[#060010] px-2 py-0.5 text-xs text-text-primary dark:text-white shadow-sm`}
          role="tooltip"
          style={{ x: '-50%' }}
        >
          {children}
